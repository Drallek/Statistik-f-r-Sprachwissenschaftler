...
# Es kann prinzipiell mehrere Modalwerte geben.
# Wenn es mehrere Elemente in der gleichen Anzahl gibt, werden alle angezeigt.
# Der Code ist in diesem Fall korrekt.
