...
body <- read.table("Drallek/body_dim_long.tab",header=TRUE) 
...
Die Koeffizienten sind unterschiedlich. Der R^2 Wert und die t-Werte sind gleich. 
...
Die t-Werte und die Koeffizienten sind unterschiedlich. Der R^2-Wert ist gleich.
...
Bei den Kursteilnehmedaten handelt es sich um zufällige Rohdaten, die auch Daten von Männern beinhalten.
Der Datensatz "women" hingegen enthält die Durchschnittsgrößen und -gewichte von US-Frauen zwischen 30 und 39 Jahren. Dieser Datensatz basiert auf means.